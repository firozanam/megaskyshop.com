...
export default function VideoSection({ videoUrl }) {
  return (
    <section className="my-16 flex flex-col items-center">
      <div className="border-4 border-[hsl(var(--primary))] p-6 rounded-lg w-[1152px] bg-card shadow-lg">
      ...
      <p className="mt-8 text-center text-lg px-4 max-w-[1152px] text-muted-foreground">
      ...
      <div className="flex justify-center mt-8">
        <Button
          ...
          variant="destructive"
          size="lg"
          className="text-lg py-6 px-10 font-semibold relative group overflow-hidden hover:scale-105 transition-transform duration-300"
        >
